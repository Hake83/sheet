/* Program to read a purchase order and add information to our excel engineering
 * schedule.  Also copies customer files over from quote folder to master customer
 * file folder.
 * Someday I will convert the schedule to use my own GUI with a sql server of some
 * type.
 *
